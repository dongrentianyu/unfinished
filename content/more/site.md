...
目前本站采用vercel，还没有购买自己的域名。未来一段时间大概率都不会买自己的域名。因为域名还要续费，还要证书，觉得麻烦。不如免费域名。这样即使有一天，写不了文章了，也不会因为域名的原因而找不到网站。
...
- 分类通常是随意的，有的会按文章推荐阅读程度，有的会随便写点。
- 实际的内容分类应该是列在标签里的，标签可以多样化，也更实际。
